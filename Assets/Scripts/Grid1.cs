...
public class GridV<TGridObject>
{
    ...
    public GridV(int width, int height, float cellSize, Vector3 originPosition, Func<GridV<TGridObject>, int, int, TGridObject> createGridObject)
    {
        this.width = width;
        this.height = height;
